# Contributing to EcommerceHub

Thank you for your interest in contributing to **EcommerceHub**! 🙌  
...
git clone https://github.com/shafqat-baloch786/EcommerceHub.git
cd EcommerceHub
...
4. **Commit your changes** with clear messages:
   ...
   ```bash
   git add .
   git commit -m "feat(cart): add product quantity validation"
   ```
...
Thank you for helping improve **EcommerceHub**! 💻✨